...
//Asunto:  Hacer un marco con borde doble que ocupe toda la pantalla y centrar un texto dentro del marco
//Autor: Paola Saldaña: 1104081 y Johan Contreras
...
int main(){
	DibujarCuadro(0, ancho, 0, largo, "Hola Casimiro");
	return 0;	
}
Footer
© 2023 GitHub, Inc.
